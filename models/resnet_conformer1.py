...
class ConformerConvModule(nn.Module):
    def __init__(self, n_inputs, n_outputs, kernel_size=3, stride=1, dilation=1, padding=1, dropout=0.2, growth=2):
        ...
        self.conv = nn.Sequential(
            ...
            nn.GLU(dim=1),
            # -- dw
            nn.Conv1d(n_inputs, n_inputs, kernel_size, stride=stride, padding=dilation_pad, dilation=dilation,
                      groups=n_inputs),
...
class ResNet(nn.Module):
    ...
    def __init__(self,
        ...
        self.conv1 = nn.Conv2d(7, self.in_channel, kernel_size=7, stride=2,
...
class ResnetConformer(nn.Module):
    def __init__(self, in_feat_shape, out_shape=None, params=None):
        super().__init__()
        ...
        self.linear_out = nn.Linear(256 , 3 * 13, bias=True)
